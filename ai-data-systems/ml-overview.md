...
### 数据结构
- [数组](../computer-science/data-structures/array.md)：特征向量与数据矩阵
- [树](../computer-science/data-structures/tree.md)：决策树模型
- [图](../computer-science/data-structures/graph.md)：图神经网络与关系数据
